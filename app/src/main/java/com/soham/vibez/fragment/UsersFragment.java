...
import com.soham.vibez.adapter.RecyclerViewAdapterUsers;
...
public class UsersFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rcvUsers = view.findViewById(R.id.recyclerViewUsers);
        ...
        db.getReference("Users").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                adapter = new RecyclerViewAdapterUsers(userList, getActivity());
